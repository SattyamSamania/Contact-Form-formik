    ...
    return (
        <div className='main'>
            <div className='m-4 w-[100]'>
                ...
                <p className='text-[18px] text-[#f9f9f9] w-[55%]'>This Project Contains the Collection of UI Components that I am creating using Next JS and Tailwind with various Libraries.</p>
                <div className='mt-3'>
